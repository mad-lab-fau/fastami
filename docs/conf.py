...
URL = "https://github.com/mad-lab-fau/fastami"
...
sphinx_gallery_conf = {
    ...
    "reference_url": {"fastami": None, **{k: v[0] for k, v in intersphinx_module_mapping.items()}},
...
linkcode_resolve = make_linkcode_resolve(
    "fastami",
    "https://github.com/mad-lab-fau/fastami/blob/{revision}/{package}/{path}#L{lineno}",
)
